...
angular.module('Feniks', []).config([
  ...
  $http.get("https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCgUafpxg3uzUhhMHmzwIfdA&maxResults=10&order=date&key=AIzaSyCYtgmB5gOlp3R8fEz6vUv7noVQ0r9O5co").success(function(response) {
